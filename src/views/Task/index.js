...
function Task({ match }) {
	...
	async function Save() {
		...
		if (!description) return alert('Você precisa informar a descrição da terefa');
		if (!type) return alert('Você precisa selecionar o tipo da terefa');
		if (!date) return alert('Você precisa definir a data da terefa');
